...
\item Scroll further down the \motif{DOC\_CYCLIN\_1} page 
	...
	database (\ref{fig:explore_content_doc_cyclin_abstrac_instances}.)
...
\begin{figure}[h!]
	...
	\label{fig:explore_content_doc_cyclin_abstract_instances}
\end{figure}

\item Scroll further down the \motif{DOC\_CYCLIN\_1} page to view
	the ``Instances'' header
	(Fig. \ref{fig:explore_content_doc_cyclin_abstract_instances})
