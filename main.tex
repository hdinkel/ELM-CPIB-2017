...
\item In the ``Taxonomic Context'' field, enter the text ``Homo
...
\item The bacterial protein \uniprot{CV\_0974} is likely to be an effector protein, similarly to its
...
\item Lastly change the ``Motif probability cutoff value'' to a more
	...
	results to motifs which are more less likely to be found by random
