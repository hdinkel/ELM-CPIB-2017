...
\begin{figure}[h!]
	...
	\caption{
	A list of all annotated pathways for the taxon \textit{Gallus gallus}. The coloring of genes/proteins is as follows:
...
\item Scroll down to below the results graphic to find additional information
	...
	(Figure~\ref{fig:predicting_p53_elm_results_alignemnt_filtering_domains}).
	The first
