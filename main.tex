...
\item Click on the sub-menu \button{ELM instances} under \button{ELM DB} to visit
...
Light green boxes are colored by KEGG and represent the KEGG hyperlinks to GENES entries, indicating the presence of genes in the genome and also the completeness of the pathway.
	}
...
\item To download a list of all motif instances detected in Human P53, type the
	following command into a terminal: \code{curl
